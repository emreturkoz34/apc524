...
SWIGINTERN PyObject *_wrap_new_Trapz(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "new_Trapz" "', argument " "1"" of type '" "double const *""'"); 
  }
  ...
  result = (Trapz *)new Trapz((double const *)arg1,arg2);
...
SWIGINTERN PyObject *_wrap_Trapz_integrate(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  res2 = SWIG_ConvertPtr(obj1, &argp2,SWIGTYPE_p_double, 0 |  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "Trapz_integrate" "', argument " "2"" of type '" "double const *""'"); 
  }
  arg2 = reinterpret_cast< double * >(argp2);
  result = (double)(arg1)->integrate((double const *)arg2);
  resultobj = SWIG_From_double(static_cast< double >(result));
