...
print ''
print 'PDF'
for i in range(0, ZmeanPoints):
    s = 'Zmean = ' + repr(round(Zmean.GetVal(i),2)) + ', pdfValM = ' + repr(pdfValM.GetVal(ZvarPrint, ZmeanPrint, i))
    print s
